# Analysing global earthquakes
The goal of this project is to analyze real-time earthquake data streaming and gain insights into earthquake distribution across multiple factors. For this purpose, I am receiving streaming data from chosen source and mode through the notebook "DataEarthquake.ipynb", sourced from the [USGS](https://earthquake.usgs.gov/earthquakes/feed/v1.0/geojson.php) public API, which provides earthquake data for the chosen time interval in the menu on a global scale every 60 seconds.
<br><br>
